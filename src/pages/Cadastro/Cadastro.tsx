...
const Cadastro = ()=>{
    ...
    return (<>
        <div className="grid grid-cols-mobile gap-x-24 w-full h-full justify-center tablet:grid-cols-tablets tablet:gap-x-12 lg:grid-cols-desktop lg:gap-x-8 ">
                <form onSubmit={handleForm} className=" bg-white rounded-lg p-5 grid col-span-2 w-full justify-self-center h-full gap-4 tablet:w-3/5 tablet:col-span-full lg:col-span-full lg:w-1/2 mt-12 lg:gap-4">
                    ...
                    <TextInput idInput="confirmarSenha" label="Confirme sua senha:" typeInput="password" name="confirmarSenha" placeholder="Senha:" className="flex flex-col gap-2" value={confirmar}
